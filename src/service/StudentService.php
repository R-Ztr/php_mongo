...
class StudentService
{
    ...
    function displayStudents(): void
    {
        ...
        try{
            ...
            // Ajout log succes => DEBUG - Afficher : Affichage de tout les étudiants.
        } catch (PDOException $e) {
            print("Erreur lors de findAll : " . $e->getMessage());
            // Ajout log erreur => ERR - Afficher : Erreur lors de l'affichage de tout les étudiants.
        }
    ...
    function createStudent(): bool
    {
        ...
        if (empty($firstname)) {
            ...
            // Ajout Log => WARN - Création : Erreur lors de la création d'un étudiant (prenom incorrect)
            return false;
        }
